...
const COLLECT_USER_INFO_FUNCTION = {
    ...
    parameters: {
        ...
        properties: {
            ...
            interests: {type: "string", description: "A comma separated list of all of the things that the user expressed interest in or asked about. Examples: 2 bedroom apartment, location, pool, pet policy, tours, apartment availability."},
