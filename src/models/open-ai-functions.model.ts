...
const COLLECT_USER_INFO_FUNCTION = {
    ...
    parameters: {
        ...
        properties: {
            ...
            interests: {type: "string", description: "A comma separated list of things that the user expressed interest in or seemed interested in. Examples: amenities, location, pet policy, tours, apartment availability."},
